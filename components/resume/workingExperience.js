export default function WorkingExperience({ homePage }) {
  ...
  return (
    <div className="flex-1">
      ...
      <div className="pl-2.5 md:pl-0  h-full  ">
        {workingExperiences?.map((workingExperience) => {
          return (
            <div
              key={workingExperience?._key}
              className="relative  h-full  block items-start rounded-full border-white border-opacity-20 first:mt-0 md:flex"
            >
              ...
              <div className="relative h-full border-l-4 border-white border-opacity-20 pt-16 pl-12 md:pt-6">
                ...
                <p className="text-[#bfbecb]">
                  {workingExperience?.description
                    ...
                    .map((item, index) => {
                      return (
                        <span key={'workingExperience-' + index}>
                          {item}
                          <br />
                        </span>
                      );
