    ...
    <>
      ...
      <div className="realative  w-full h-64 ">
        ...
        <div className="relative flex flex-col justify-center items-center h-full  w-full">
          ...
          ></div>
          <h1 className="px-2 max-w-screen-xl text-center capitalize flex mb-2 text-secondary-400 antialiased font-bold text-4xl	pt-20">
            {blog?.title}
          </h1>
        </div>
      </div>
...
export async function getServerSideProps(context) {
  ...
  let { blog } = await getBlogPreviewBySlug(slug);
